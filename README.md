...
After the factory part is completed make a pull request against `leap-16.0` and `leap-16.1` branches in https://src.opensuse.org/pool/opensuse-migration-tool
idally from the factory branch once the change is accepted in Factory/Tumbleweed.
